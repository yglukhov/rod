...
type OldMaskType* = enum
    tmNone, tmAlpha, tmAlphaInverted, tmLuma, tmLumaInverted

type OldMask* = ref object of RenderComponent
...
method setupMaskPost(c: Component, maskType: OldMaskType): bool {.base.} = false

method isMaskAplicable(s: Sprite): bool = true
method setupMaskPost(s: Sprite, maskType: OldMaskType): bool =
